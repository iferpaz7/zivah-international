...
export const metadata: Metadata = {
  ...
  description: 'Información sobre protección de datos personales según RGPD y leyes aplicables - ZIVAH International S.A.',
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
              <li><strong>Reglamento (UE) 2016/679 (RGPD):</strong> Para residentes de la Unión Europea</li>
              <li><strong>Ley Orgánica de Protección de Datos Personales (LOPD):</strong> Ecuador</li>
              <li><strong>California Consumer Privacy Act (CCPA):</strong> Para residentes de California</li>
              <li><strong>Normativas sectoriales:</strong> Aplicables al comercio internacional de alimentos</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li><strong>Ejecución de contrato:</strong> Para procesar pedidos y cotizaciones</li>
              <li><strong>Interés legítimo:</strong> Para mejorar nuestros servicios y prevenir fraudes</li>
              <li><strong>Cumplimiento de obligaciones legales:</strong> Para cumplir con regulaciones aplicables</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
              <li><strong>Datos de clientes activos:</strong> Durante la relación comercial y 5 años después</li>
              <li><strong>Datos de cotizaciones:</strong> 3 años desde la última actividad</li>
              <li><strong>Datos de marketing:</strong> Hasta que retire su consentimiento</li>
              <li><strong>Datos de navegación:</strong> 2 años para análisis estadísticos</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h5 className="font-medium text-blue-900 dark:text-blue-100 mb-2">Por Correo Postal</h5>
                  <p className="text-blue-800 dark:text-blue-200 text-sm">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
              Para verificar su identidad, podremos solicitarle información adicional.
              Todos los derechos se ejercen de forma gratuita, salvo que las solicitudes sean manifiestamente infundadas o excesivas.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li><strong>Copias de seguridad:</strong> Regulares y seguras</li>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Sus datos pueden transferirse a países fuera del Espacio Económico Europeo (EEE).
              En estos casos, garantizamos que las transferencias cumplan con las garantías adecuadas
              establecidas por la legislación aplicable, incluyendo cláusulas contractuales tipo
              o decisiones de adecuación de la Comisión Europea.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              Si considera que el tratamiento de sus datos personales no cumple con la normativa aplicable,
              tiene derecho a presentar una reclamación ante la autoridad de control competente:
            </p>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
              <li><strong>En Ecuador:</strong> Agencia de Regulación y Control de las Telecomunicaciones (ARCOTEL)</li>
              <li><strong>En la UE:</strong> Autoridad de Protección de Datos de su país de residencia</li>
              <li><strong>En España:</strong> Agencia Española de Protección de Datos (AEPD)</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Esta política puede actualizarse para reflejar cambios en nuestras prácticas o en la legislación aplicable.
              Le informaremos sobre cambios significativos mediante un aviso destacado en nuestro sitio web
              o enviando una comunicación directa.
            </p>
          </section>
        </div>
