...
export const metadata: Metadata = {
  ...
  description: 'Términos y condiciones de uso del sitio web de ZIVAH International S.A. - Condiciones para el uso de nuestros servicios.',
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Al acceder y utilizar el sitio web de ZIVAH International S.A. (&quot;nosotros&quot;, &quot;nuestro&quot; o &quot;ZIVAH&quot;),
              usted acepta estar sujeto a estos Términos y Condiciones de Uso. Si no está de acuerdo con estos términos,
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
              <li><strong>&quot;Sitio Web&quot;:</strong> El sitio web de ZIVAH International S.A. ubicado en zivahinternational.com</li>
              <li><strong>&quot;Servicios&quot;:</strong> Todos los servicios ofrecidos por ZIVAH International S.A., incluyendo cotizaciones, información de productos, y soporte</li>
              <li><strong>&quot;Usuario&quot;:</strong> Cualquier persona que accede o utiliza el Sitio Web</li>
              <li><strong>&quot;Contenido&quot;:</strong> Toda la información, texto, gráficos, imágenes, y otros materiales disponibles en el Sitio Web</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Usted puede utilizar el Sitio Web únicamente para fines legales y de acuerdo con estos términos.
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Toda la información sobre productos en nuestro sitio web es de carácter general e informativo.
              Las especificaciones, precios y disponibilidad pueden cambiar sin previo aviso.
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              No constituyen una oferta firme hasta que sean confirmadas por escrito por ZIVAH International S.A.
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Nos esforzamos por mantener la precisión de la información de productos, pero no garantizamos
              la disponibilidad de todos los productos en todo momento.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              software y código fuente, está protegido por leyes de propiedad intelectual y es propiedad de
              ZIVAH International S.A. o sus licenciantes.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Queda prohibida la reproducción, distribución, modificación o creación de obras derivadas
              sin el consentimiento expreso y por escrito de ZIVAH International S.A.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <Link href="/legal/privacy-policy" className="text-green-600 dark:text-green-400 hover:underline">
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              profesional específico. Siempre debe consultar con expertos calificados para decisiones comerciales.
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              El sitio web y los servicios se proporcionan &quot;tal cual&quot; sin garantías de ningún tipo,
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ZIVAH International S.A. no será responsable por daños directos, indirectos, incidentales,
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              de los tribunales competentes de Guayas, Ecuador.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              El uso continuado del sitio web después de dichos cambios constituye su aceptación
