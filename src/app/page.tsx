...
export default function HomePage() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (categoriesRes.ok && productsRes.ok) {
          ...
          console.error('API responses not ok:', { categoriesRes: categoriesRes.status, productsRes: productsRes.status })
          setCategories([])
          setProducts([])
          setFilteredProducts([])
        }
  ...
  useEffect(() => {
    if (selectedCategory === 'all') {
      ...
      const filtered = (products || []).filter(product => product.category?.slug === selectedCategory)
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                ...
                <span className="text-green-600 dark:text-green-400">Ecuatorianos</span>{' '}
                para Mercados Internacionales
              </h1>
              
              <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                Desde Ecuador hacia el mundo, conectamos la excelencia ecuatoriana con compradores globales. Con sede 
                principal en Samborondón, Guayas y oficina de distribución en Miami, somos especialistas en acuicultura, 
                larvas de camarón, cultivo de árboles frutales y productos premium ecuatorianos.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <button onClick={() => scrollToSection('productos')} className="bg-green-600 dark:bg-green-500 text-white px-8 py-4 rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors text-center font-medium">
                  Explorar Productos
                </button>
                <button onClick={() => scrollToSection('cotizar')} className="border-2 border-green-600 dark:border-green-400 text-green-600 dark:text-green-400 px-8 py-4 rounded-lg hover:bg-green-600 dark:hover:bg-green-500 hover:text-white transition-colors text-center font-medium">
                  Solicitar Cotización
                </button>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600 dark:text-gray-400">Contenedores/Año</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600 dark:text-gray-400">Calidad Garantizada</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:text-right">
              <div className="glass-card p-8 rounded-2xl">
                ...
                <div className="text-gray-700 dark:text-gray-300">
                  Frutas • Mariscos • Café • Acuicultura • Árboles Frutales • Nueces
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
              {loading ? 'Cargando productos...' : 'Desde frutas tropicales hasta productos marinos premium y larvas de acuicultura, llevamos lo mejor de Ecuador a mesas de todo el mundo con la más alta calidad y trazabilidad.'}
            </p>
          </div>
          ...
          {loading ? (
            <div className="grid lg:grid-cols-2 gap-8">
              {[...Array(4)].map((_, index) => (
                <div key={index} className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 animate-pulse">
                  ...
                  <div className="space-y-2 mb-6">
                    {[...Array(4)].map((_, idx) => (
                      <div key={idx} className="h-4 bg-gray-100 dark:bg-gray-600 rounded"></div>
                    ))}
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {(categories || []).map((category, index) => {
                ...
                return (
                  <div key={category.id} className={`${bgColors[index % bgColors.length]} p-8 rounded-2xl border`}>
                    ...
                    <ul className="space-y-2 mb-6">
                      {categoryProducts.slice(0, 4).map((product) => (
                        <li key={product.id} className="flex items-center text-gray-700 dark:text-gray-300">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800" id="todos-productos">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              {loading ? 'Cargando productos...' : `${(filteredProducts || []).length} variedades de productos premium ecuatorianos disponibles para exportación mundial`}
            </p>
            ...
            {!loading && (categories || []).length > 0 && (
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                ...
                {(categories || []).map((category) => {
                  const categoryProductCount = (products || []).filter(p => p.category?.slug === category.slug).length
                  return (
                    <button
                      key={category.id}
          ...
          {loading ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
              {[...Array(12)].map((_, index) => (
                <div key={index} className="bg-white dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600 animate-pulse">
                  ...
                  {product.certifications && product.certifications.length > 0 && (
                    <div className="mt-2 flex flex-wrap gap-1 justify-center">
                      {product.certifications.slice(0, 2).map((cert, idx) => (
                        <span key={idx} className="text-xs bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 px-2 py-1 rounded">
                          {cert}
                        </span>
                      ))}
                      {product.certifications.length > 2 && (
                        <span className="text-xs text-gray-500 dark:text-gray-400">+{product.certifications.length - 2}</span>
                      )}
                    </div>
                  )}
                </div>
      ...
      {/* Quote Section */}
      <section className="py-20 bg-gradient-to-br from-green-600 to-blue-600 text-white" id="cotizar">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Nuestros productos cumplen con los más altos estándares internacionales de calidad y seguridad alimentaria. 
                Cada envío está respaldado por certificaciones reconocidas mundialmente y procesos de trazabilidad completos 
                desde la finca hasta el destino final.
              </p>
              
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">HACCP</div>
                  <div className="text-gray-600 dark:text-gray-400">Análisis de Peligros</div>
                </div>
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">BRC</div>
                  <div className="text-gray-600 dark:text-gray-400">Seguridad Alimentaria</div>
                </div>
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">BAP</div>
                  <div className="text-gray-600 dark:text-gray-400">Acuicultura Responsable</div>
                </div>
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">GlobalGAP</div>
                  <div className="text-gray-600 dark:text-gray-400">Buenas Prácticas</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800" id="mercados">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
              Desde Ecuador hacia el mundo, nuestra red logística con oficina de distribución en Miami nos permite 
              llegar a los principales mercados mundiales con la eficiencia y calidad que nuestros clientes demandan
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-16">
            <div className="text-center">
              <div className="text-4xl font-bold text-green-600 dark:text-green-400">8+</div>
              <div className="text-gray-600 dark:text-gray-400">Países Atendidos</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-green-600 dark:text-green-400">50+</div>
              <div className="text-gray-600 dark:text-gray-400">Contenedores por Año</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600 dark:text-gray-400">Productos Certificados</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600 dark:text-gray-400">Soporte Especializado</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Estamos aquí para ayudarte con todas tus necesidades de importación de productos ecuatorianos
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
              ...
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Oficina Principal</h4>
              <p className="text-gray-600 dark:text-gray-400">Samborondón, Guayas<br />Ecuador</p>
            </div>

            <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
              <div className="text-4xl mb-4">🏢</div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Oficina de Distribución</h4>
              <p className="text-gray-600 dark:text-gray-400">Miami, Florida<br />Estados Unidos</p>
            </div>

            <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
              <div className="text-4xl mb-4">📧</div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Email Comercial</h4>
              <p className="text-gray-600 dark:text-gray-400">sales@zivahinternational.com<br />info@zivahinternational.com</p>
            </div>

            <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
              <div className="text-4xl mb-4">📱</div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Teléfonos</h4>
              <p className="text-gray-600 dark:text-gray-400">+1 (305) XXX-XXXX<br />WhatsApp: +593 9X XXX XXXX</p>
            </div>
          </div>

          <div className="mt-12 text-center p-8 bg-gray-50 dark:bg-gray-800 rounded-xl">
            <div className="text-4xl mb-4">⏰</div>
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Horario de Atención</h4>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <strong className="text-gray-900 dark:text-white">Sede Principal (Ecuador):</strong><br />
                <span className="text-gray-600 dark:text-gray-400">
                  Lunes - Viernes: 8:00 AM - 6:00 PM ECT<br />
                  Sábados: 9:00 AM - 2:00 PM ECT
                </span>
              </div>
              <div>
                <strong className="text-gray-900 dark:text-white">Oficina Miami:</strong><br />
                <span className="text-gray-600 dark:text-gray-400">
      ...
      <footer className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">ZIVAH International S.A.</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                Exportadores premium de productos ecuatorianos con más de 4 años conectando Ecuador con el mundo 
                desde nuestra sede principal en Samborondón, Guayas.
              </p>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                <strong className="text-gray-900 dark:text-white">Especialistas en:</strong> Acuicultura, Larvas de Camarón, Frutas Tropicales, 
                Productos del Mar y Café de Altura.
              </p>
            </div>

            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Productos Principales</h4>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li><a href="#productos" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Frutas Tropicales</a></li>
                <li><a href="#productos" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Productos del Mar</a></li>
                <li><a href="#productos" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Café Arábica</a></li>
                <li><a href="#productos" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Camarón Premium</a></li>
                <li><a href="#productos" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Larvas de Camarón</a></li>
                <li><a href="#todos-productos" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Ver Catálogo Completo</a></li>
              </ul>
            </div>

            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Servicios</h4>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li><a href="#calidad" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Certificaciones</a></li>
                <li><a href="#cotizar" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Cotizaciones</a></li>
                <li><a href="#mercados" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Distribución Global</a></li>
                <li><a href="#contacto" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Asesoría Técnica</a></li>
                <li><a href="#contacto" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Soporte 24/7</a></li>
              </ul>
            </div>
