...
Crawl-delay: 1`
  ...
  validateSitemapUrls: async (urls: MetadataRoute.Sitemap): Promise<{
    valid: string[]
    invalid: string[]
  }> => {
    const results = await Promise.allSettled(
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  monitorSitemapChanges: (currentUrls: MetadataRoute.Sitemap, previousUrls: MetadataRoute.Sitemap) => {
