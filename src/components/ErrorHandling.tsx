...
export function LoadingSpinner({ size = 'md', message = 'Cargando...' }: {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8">
      <div className={`${sizeClasses[size]} border-4 border-green-200 dark:border-green-800 border-t-green-600 dark:border-t-green-400 rounded-full animate-spin mb-4`}></div>
      {message && (
...
export function Toast({ message, type, onClose }: ToastProps) {
  ...
  return (
    <div className={`fixed top-4 right-4 ${typeStyles[type]} px-4 py-3 rounded-lg shadow-lg z-50 max-w-sm`}>
