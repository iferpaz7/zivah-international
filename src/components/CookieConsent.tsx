          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
            <div className="flex-1">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                ...
                <Link href="/legal/cookie-policy" className="text-green-600 dark:text-green-400 hover:underline">
                  Política de Cookies
                </Link>.
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Nos ayudan a entender cómo los visitantes interactúan con nuestro sitio web mediante la recopilación
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Permiten recordar sus preferencias y configuraciones para mejorar su experiencia de navegación.
                  </p>
                </div>
