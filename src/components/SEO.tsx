...
export default function SEO({
  ...
  keywords = ['exportación ecuador', 'frutas tropicales', 'camarón ecuatoriano', 'larvas acuicultura', 'cafe arabica', 'productos marinos', 'miami exportadores'],
  ...
  useEffect(() => {
    ...
    updateMetaTags()
  }, [title, description, keywords, image, url, type, publishedTime, modifiedTime, author, section, tags, canonical, noindex])
