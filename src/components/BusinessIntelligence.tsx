...
export function useBusinessTracking() {
  const { trackEvent, trackConversion, trackProductView, trackQuoteRequest, trackFormSubmission } = useAnalytics()
  ...
  const trackBusinessConversion = (conversionType: 'quote_request' | 'contact' | 'newsletter' | 'download', value?: number) => {
