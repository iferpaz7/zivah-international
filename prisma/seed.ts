...
async function main() {
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['MPS', 'Rainforest Alliance', 'GlobalGAP', 'Flowerabel']),
      isActive: true,
      isFeatured: true,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['GlobalGAP', 'HACCP', 'Orgánico', 'Rainforest Alliance']),
      nutritionalInfo: JSON.stringify({
        calories: 160,
        protein: '2g',
        carbs: '9g',
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      certifications: JSON.stringify(['GlobalGAP', 'HACCP', 'Orgánico', 'SENASA']),
      nutritionalInfo: JSON.stringify({
        calories: 60,
        protein: '0.8g',
        carbs: '15g',
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      certifications: JSON.stringify(['Orgánico', 'Comercio Justo', 'Rainforest Alliance', 'SCA']),
      isActive: true,
      isFeatured: true,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      certifications: JSON.stringify(['Orgánico', 'GlobalGAP']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['GlobalGAP', 'HACCP']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      certifications: JSON.stringify(['GlobalGAP', 'Orgánico']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['Orgánico', 'GlobalGAP', 'HACCP']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      certifications: JSON.stringify(['GlobalGAP', 'HACCP', 'Orgánico']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['Orgánico', 'Rainforest Alliance', 'FSC']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['GlobalGAP', 'HACCP', 'Rainforest Alliance']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  // LARVAS DE CAMARÓN - Ecuador's aquaculture specialty
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['SENASA', 'OIRSA', 'Laboratorio Certificado', 'SPF']),
      isActive: true,
      isFeatured: true,
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['MSC', 'HACCP', 'BRC', 'IUU-free']),
      nutritionalInfo: JSON.stringify({
        calories: 144,
        protein: '23g',
        fat: '5g',
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      origin: 'Ecuador',
      harvestSeason: 'Todo el año',
      certifications: JSON.stringify(['SENASA', 'Fitosanitario']),
      isActive: true,
      isFeatured: false,
    },
  });
  ...
  console.warn('  - 28 comprehensive export products with MySQL-compatible data');
  console.warn(
  ...
  if (products.length > 0 && measures.length > 0) {
    ...
    const kgMeasure = measures.find(m => m.shortName === 'kg');
    const tonMeasure = measures.find(m => m.shortName === 'MT');
  ...
  if (measures.length > 0) {
    const kgMeasure = measures.find(m => m.shortName === 'kg');
    const lbMeasure = measures.find(m => m.shortName === 'lb');
    const tonMeasure = measures.find(m => m.shortName === 'MT');
